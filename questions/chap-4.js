...
colorDiv.addEventListener('mouseover', changeBgFunction)
...
toggleElement.addEventListener('click', toggleElement)
...
document.getElementById('nasr-is-cool').removeEventListener('click', myFunction)
